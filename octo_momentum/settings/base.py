"""
Django settings for octo_momentum project.
...
INSTALLED_APPS = [
    ...
    # Required by wagtailsearch's SearchVectorField/GinIndex on PostgreSQL.
...
ROOT_URLCONF = "octo_momentum.urls"
...
WSGI_APPLICATION = "octo_momentum.wsgi.application"
